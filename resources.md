...
- [Kubernetes API Reference](https://kubernetes.io/docs/reference/) — Official API docs, kubectl commands, and configuration specs
- [Kubernetes Documentation](https://kubernetes.io/docs/) — Official guides, tutorials, and concepts
- [KCNA Curriculum (CNCF)](https://github.com/cncf/curriculum) — Official exam curriculum and domain breakdown
- [CNCF Landscape](https://landscape.cncf.io/) — Interactive map of all CNCF projects and ecosystem tools
